...
* replace `200` response codes with `409`
...
This will tell Network Monkey to randomly replace a 200 success code with a 409. If Network Monkey detects a non-200 code it will let that pass through. That way if your app really is experiencing a problem from your network you are alerted to it.
